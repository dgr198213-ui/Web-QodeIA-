        ...
        <div className="bg-qodeia-dark-800 py-8 px-4 shadow-xl border border-qodeia-blue-500/20 sm:rounded-lg sm:px-10">
          <div className="space-y-6">
            <button
              ...
              disabled={loading}
              className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-qodeia-blue-500 transition-all"
            >
              {loading ? (
